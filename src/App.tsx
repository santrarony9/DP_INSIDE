...
export default function App() {
  ...
  const handleAddFreelancerToPool = (e: React.FormEvent) => {
    ...
    setTeam((prev) =>
      prev.map((t) => {
        if (t.id === 'usr-freelance-pool') {
          const updatedRoster = [
            ...(t.freelancerPoolRoster || []),
            {
              id: `fl-${Date.now()}`,
              name: newFlName,
          ...
          return { ...t, freelancerPoolRoster: updatedRoster };
        }
        return t;
      })
    );
      ...
      prev.map((t) => {
        if (t.id === 'usr-3') {
          return {
            ...
            weeklyHoursLogged: t.weeklyHoursLogged
          };
        }
        return t;
      })
              ...
              <button 
                ...
                onClick={() => {
                  if (!isTimerRunning) {
                    ...
                    setTeam((prev) => prev.map((t) => t.id === activeWebCheckInUser ? {
                      ...t,
                      status: 'active-editing',
